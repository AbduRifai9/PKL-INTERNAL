...
<body>
    ...
    <div class="flex-container-cards">
        ...
        <div class="card">
            ...
            <div class="card-content">
                ...
                <div class="button-shadow">
                    <a href="{{ route('intj.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        </div>
        {{-- <div class="card" style="width: 20rem;">
                <img src="{{ asset('backend/image/Librarian.jpeg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <a href="{{ url('intj') }}" type="submit"
                        class="btn btn-primary rounded-pill text-white px-5 float-end">INTJ
                    </a>
                </div>
            </div> --}}

        <div class="card">
            <div class="card-img-shadow"><img src="{{ asset('backend/image/rabbids invasion icon (1).jpeg') }}"
                    alt="wanda"></div>
            <div class="card-content">
                <h2>INTP</h2>
                <div class="button-shadow">
                    <a href="{{ route('intp.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img src="{{ asset('backend/image/rabbids invasion icon.jpeg') }}"
                    alt="wanda"></div>
            <div class="card-content">
                <h2>ENTP</h2>
                <div class="button-shadow">
                    <a href="{{ route('entp.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img src="{{ asset('backend/image/matching pfp (3_3) (1).jpeg') }}"
                    alt="wanda"></div>
            <div class="card-content">
                <h2>INFJ</h2>
                <div class="button-shadow">
                    <a href="{{ route('infj.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img
                    src="{{ asset('backend/image/7cbd8aca-177d-4ccd-b170-fea1d472c754.jpeg') }}" alt="wanda"></div>
            <div class="card-content">
                <h2>INFP</h2>
                <div class="button-shadow">
                    <a href="{{ route('infp.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img src="{{ asset('backend/image/rabbids invasion icon (6).jpeg') }}"
                    alt="wanda"></div>
            <div class="card-content">
                <h2>ENFP</h2>
                <div class="button-shadow">
                    <a href="{{ route('enfp.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img
                    src="{{ asset('backend/image/1a061480-4736-4b0b-b83c-006fa3d7869b.jpeg') }}" alt="wanda"></div>
            <div class="card-content">
                <h2>ISTJ</h2>
                <div class="button-shadow">
                    <a href="{{ route('istj.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img src="{{ asset('backend/image/rabbids invasion icon (9).jpeg') }}"
                    alt="wanda"></div>
            <div class="card-content">
                <h2>ISFJ</h2>
                <div class="button-shadow">
                    <a href="{{ route('isfj.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img
                    src="{{ asset('backend/image/✧ ➳ 𝘙𝘢𝘣𝘣𝘪𝘵𝘴 𝘪𝘯𝘷𝘢𝘴𝘪𝘰𝘯 𝘪𝘤𝘰𝘯𝘴 ❏.jpeg') }}"
                    alt="wanda"></div>
            <div class="card-content">
                <h2>ESFJ</h2>
                <div class="button-shadow">
                    <a href="{{ route('esfj.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img src="{{ asset('backend/image/matching pfp (1_3).jpeg') }}"
                    alt="wanda"></div>
            <div class="card-content">
                <h2>ISTP</h2>
                <div class="button-shadow">
                    <a href="{{ route('istp.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img
                    src="{{ asset('backend/image/7a7b314e-7e23-499e-bc31-54c9d26f292d.jpeg') }}" alt="wanda">
            </div>
            <div class="card-content">
                <h2>ISFP</h2>
                <div class="button-shadow">
                    <a href="{{ route('isfp.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-img-shadow"><img src="{{ asset('backend/image/rabbids invasion icon (15).jpeg') }}"
                    alt="thor"></div>
            <div class="card-content">
                <h2>ESFP</h2>
                <div class="button-shadow">
                    <a href="{{ route('esfp.index') }}">
                        <div class="card-button">Detail</div>
                    </a>
                </div>
            </div>
        ...
        <div class="card">
            <div class="button-shadow">
                <a href="/">
                    <div class="card-button">Kembali Ke Home Page </div>
                </a>
            </div>
        </div>
        <div class="card">
            <div class="button-shadow">
                <a href="{{ route('tes.index') }}">
                    <div class="card-button">Test MBTI </div>
                </a>
            </div>
        </div>
    </div>
