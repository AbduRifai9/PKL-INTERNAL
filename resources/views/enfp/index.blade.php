    ...
    <div class="contents">
        ...
        <div class="box show" data-content="0">
            ...
            <div>
                ...
                <ul style="font-family: Arial, Helvetica, sans-serif;">
                    ENFP adalah akronim dari extroverted, intuitive, feeling, dan perceiving. Individu dengan
                    kepribadian ini sangat suka mengumpulkan ide-ide positif yang bisa mencerminkan harapan dan niat
                    baiknya terhadap orang lain.
                </ul>
        ...
        <div class="box hide" data-content="3">
            ...
            <div>
                ...
                <ul style="font-family: Arial, Helvetica, sans-serif;">
                    <li>Individu P digambarkan sebagai pribadi yang sangat suka membantu orang lain dan memiliki
                        kemampuan dalam memahami keinginan, kebutuhan, dan maksud orang lain.
                        ...
                        psikolog, pekerja sosial, konselor, guru, dosen, manajer, atau sukarelawan.</li>
                </ul>
                <button onclick="location.href='{{ route('tes.index') }}'" type="button" class="custom-btn btn-5">Test
                    MBTI</button>
                <button onclick="location.href='/'" type="button" class="custom-btn btn-5">Homepage</button>
